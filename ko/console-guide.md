...
- **대시보드**에서 NHN AppGuard가 탐지한 어뷰징 사용자의 통계 그래프와 목록을 검색할 수 있습니다.
...
- **이상 행위 탐지 현황**은 API를 이용해 JSON 형태로도 조회할 수 있습니다. 자세한 내용은 [API 가이드](./api-guide/)를 참고하세요.
...
아래 환경에서는 앱 증명 토큰이 발급되지 않습니다. **체크박스**로 개별 항목을 활성화하거나 비활성화할 수 있습니다.
...
* **앱 Public 키**: 앱 SDK의 Public Key로, 앱 증명에 필요한 정보입니다.
* **상품 Public 키**: 앱에 귀속된 서버의 Public Key로, 앱 증명에 필요한 정보입니다.
