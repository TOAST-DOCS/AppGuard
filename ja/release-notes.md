...
* [Android] 1.14.0.0
    * DEX暗号化対象の指定機能を追加
        * パッケージまたはクラス単位でDEX暗号化対象を選択できる機能を追加しました。
        * 詳細については、**Android Developer's Guide > 3. 統合設定ファイル > 3.2 機能別設定 > DEX暗号化対象の指定**を参照してください。
    * 統合設定ファイルのサポート
        * リソース文字列の難読化ルールとDEX暗号化範囲を1つの統合設定ファイルで管理できるように改善しました。
        * 詳細については、**Android Developer's Guide > 3. 統合設定ファイル**を参照してください。
    * Android IDベースのブラックリスト機能を追加
        * Android IDを基準に特定の端末をブラックリストに登録できる機能を追加しました。
    * エミュレータ検知パターンを追加
        * UgPhoneエミュレータの検知パターンを追加しました。
    * バグ修正
        * MyCard決済時にアプリが異常終了する問題を修正しました。
        * リモート制御アプリの検知時に発生する誤検知を修正しました。
* [iOS] 1.6.0
    * iOSの最小サポートバージョンの引き上げ
        * 最小サポートバージョンをiOS 13に引き上げました。
    * 安定性の改善
* [Unity] 0.5.2
    * iOS環境でSecureValueの改ざん時に遮断が正常に動作しない問題を修正しました。
    * iOS SDK 1.6.0アップデート
* [Unreal] 0.2.11
    * iOS SDK 1.6.0アップデート
* [Console]
    * Android統合設定ファイルのアップロード機能を追加
        * Androidアプリ保護作業に使用する統合設定ファイルをアップロードできる機能を追加しました。
    * Android IDベースのブラックリスト遮断機能を追加
        * ブラックリストでAndroid IDを基準に特定の端末を遮断できる機能を追加しました。

<a id="august-19-2026"></a>
### 2026. 08. 19. { #august-19-2026 }

* [Android] 1.13.3.2
    * Unity環境でのネイティブライブラリ(.so)の整合性検証の誤検知を修正
