...
* [iOS] 1.6.0
    ...
    * 安定性の改善
* [Unity] 0.5.2
    * iOS環境でSecureValue改ざん時に遮断が正常に動作しない問題を修正しました。
    * iOS SDK 1.6.0アップデート
* [Unreal] 0.2.11
    * iOS SDK 1.6.0アップデート
* [Console]
    * Android統合設定ファイルのアップロード機能の追加
        * Androidアプリ保護作業に使用する統合設定ファイルをアップロードできる機能を追加しました。
    * Android IDベースのブラックリスト遮断機能の追加
        * ブラックリストでAndroid IDを基準に特定の端末を遮断できるように機能を追加しました。
