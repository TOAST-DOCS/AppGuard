...
iOS는 SDK연동(필수 사항)과 빌드된 IPA파일을 Web Console 또는 CLI를 통한 보호작업(선택 사항)을 을 통해 적용할 수 있습니다. Web Console 또는 CLI를 사용하여 보호 작업을 수행할 경우에만 일부 보호 기능(무결성 검증, 서명자 검증, 기본 정책 적용, 난독화, 플랜 적용)을 활성화할 수 있습니다.
